    ...
    <div class="container">
      ...
      <div class="service-logo text-center">
        <div class="service-logo__content d-flex flex-row justify-content-center align-items-center">
          ...
          <p class="service-logo-image d-inline-flex m-0"><img alt="となりにコーチのサービスロゴ" src="images/serviceLogo.png" class="service-logo-image__logo col img-fluid rounded-0"></p>
        </div>
